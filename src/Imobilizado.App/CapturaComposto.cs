...
namespace Imobilizado.App
{
    ...
    internal static class CapturaComposto
    {
        ...
        /// <summary>Captura o FrmImobilizado carregado de uma pasta (aba Bens, com as contas do PLACON).</summary>
        public static void RodarImobilizado(string pasta, string png)
        {
            var f = new FrmImobilizado();
            var _h = f.Handle;
            ((TextBox)typeof(FrmImobilizado).GetField("txtPasta", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).GetValue(f)).Text = pasta;
            typeof(FrmImobilizado).GetMethod("CarregarTudo", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).Invoke(f, null);
            f.StartPosition = FormStartPosition.Manual;
            f.Location = new Point(0, 0);
            f.Show();
            Application.DoEvents();
        ...
        /// <summary>Captura o FrmCadCusto carregado de uma pasta.</summary>
        public static void RodarCadCusto(string pasta, string png)
        {
            var f = new FrmCadCusto();
            var _h = f.Handle;
            ((TextBox)typeof(FrmCadCusto).GetField("txtPasta", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).GetValue(f)).Text = pasta;
            typeof(FrmCadCusto).GetMethod("Carregar", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).Invoke(f, null);
            f.StartPosition = FormStartPosition.Manual;
            f.Location = new Point(0, 0);
            f.Show();
            Application.DoEvents();
        ...
        /// <summary>Captura o FrmBalancoProdutos calculado de uma pasta.</summary>
        public static void RodarBalProd(string pasta, string d1, string d2, string png)
        {
            var f = new FrmBalancoProdutos();
            var _h = f.Handle;
            T Campo<T>(string nome) => (T)typeof(FrmBalancoProdutos).GetField(nome, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).GetValue(f);
            ...
            typeof(FrmBalancoProdutos).GetMethod("Calcular", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).Invoke(f, null);
            f.StartPosition = FormStartPosition.Manual;
            f.Location = new Point(0, 0);
            f.Show();
            Application.DoEvents();
