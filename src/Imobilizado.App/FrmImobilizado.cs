...
{
    /// <summary>
    /// Imobilizado / Depreciação: escolher pasta de dados + competência, ver os bens (com as
    /// contas do PLACON usadas na geração da depreciação: imobilizado, resultado=débito e
    /// dep.acumulada=crédito), pré-visualizar o lote do mês (dry-run) e gravar no MOVFIN.
    /// Aberto pelo MENU do FrmPrincipal — não carrega na abertura do aplicativo.
    /// </summary>
    public sealed class FrmImobilizado : Form
    {
        ...
        public FrmImobilizado()
        {
            Text = "Imobilizado / Depreciação";
        ...
        private void MontarUI()
        {
            ...
            statusLabel = new ToolStripStatusLabel("Informe a pasta e clique Carregar.");
        ...
        {
            base.OnShown(e);
            // dentro do form do Imobilizado o auto-load é conveniente (o usuário pediu a tela)
